        ...
        <AuthLoading>
          <div className="min-h-screen bg-linear-to-br from-indigo-100 to-purple-100 flex items-center justify-center">
            <div className="bg-white rounded-lg shadow-lg p-8">
              <p className="text-2xl font-semibold text-indigo-600">Chargement...</p>
            </div>
          </div>
        </AuthLoading>
      ) : isAuthenticated ? (
    ...
    <div className="min-h-screen bg-linear-to-br from-indigo-100 to-purple-100 flex flex-col">
      ...
      <div className="flex-grow flex flex-col items-center justify-center p-4">
        ...
        <SignInButton mode="modal">
          <Button size="lg" className="inline-block bg-indigo-600 text-white font-semibold hover:bg-indigo-700 transition-colors">
            Se connecter
          </Button>
        </SignInButton>
      </div>
      ...
      <main className="container mx-auto px-4 py-8 flex-grow mb-[56px] mt-[140px] md:mt-[100px]">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-3xl font-bold text-gray-800 mb-8">
            Bienvenue sur notre plateforme de gestion de produits pour UGS, les associations et les particuliers !
          </h1>

          <section className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Options disponibles</h2>
            <ul className="list-disc list-inside text-left space-y-2">
              ...
              <li>Pour modifier votre profil, rendez-vous dans la section en cliquant sur votre image de profil.</li>
            </ul>
          </section>
        </div>
      </main>
