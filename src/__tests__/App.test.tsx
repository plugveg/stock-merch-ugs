...
describe('App routing', () => {
  ...
  it('redirects to home if not signed in on RoleProtectedRoute', async () => {
    ...
    expect(await screen.findByText(/Veuillez vous connecter pour accéder/)).toBeInTheDocument()
  })
  ...
  it('renders nothing while auth is loading', () => {
    ...
    expect(screen.queryByText(/Veuillez vous connecter/)).not.toBeInTheDocument()
  })
  ...
  it('allows access to admin dashboard for allowed role', async () => {
    ...
    expect(await screen.findByText(/Créer un nouvel événement/i)).toBeInTheDocument()
  })
  ...
  it('redirects to dashboards when user role is not allowed', async () => {
    ...
    expect(await screen.findByText(/Sélectionnez un tableau de bord/i)).toBeInTheDocument()
  })
